...
/* recipes (fixed specs + dripbag update + Water Total label) */
const RECIPES = {
  blend_filter: {
    water_temp: "88°C",
...
function renderDetail(id){
  ...
  const videoBlock = it.video_id
    ...
    : `<div class="card">
         ...
         <div class="miniEmpty">
           <div class="miniEmptyTitle">Coming soon</div>
           <p class="miniEmptySub">Recipe video will be updated.</p>
         </div>
       </div>`;
